...
In this plot, I include all taxa that passes quality filtering for COI on genus level.
Revealing a handful of additional species with interesting seasonal patterns (as it appears)
